...
![pi-bar with low context usage](https://cdn.jsdelivr.net/npm/pi-bar@0.3.23/assets/screenshot-green.png)
![pi-bar with medium context usage](https://cdn.jsdelivr.net/npm/pi-bar@0.3.23/assets/screenshot-yellow.png)
![pi-bar with high context usage](https://cdn.jsdelivr.net/npm/pi-bar@0.3.23/assets/screenshot-red.png)
